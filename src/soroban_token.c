...
// This list is generated based on the data from https://lobstr.co/api/v1/sep/assets/curated.json.
...
static const soroban_token_t tokens[] = {
...
#ifndef TARGET_NANOS
    // CBVJZDNMOPEEPED3OBY4VLQPQKU4IOCKWACDKXPBO4E6TQI432W66BE5
    {{
         0x6a, 0x9c, 0x8d, 0xac, 0x73, 0xc8, 0x47, 0x90, 0x7b, 0x70, 0x71,
         0xca, 0xae, 0x0f, 0x82, 0xa9, 0xc4, 0x38, 0x4a, 0xb0, 0x04, 0x35,
         0x5d, 0xe1, 0x77, 0x09, 0xe9, 0xc1, 0x1c, 0xde, 0xad, 0xef,
     },
     "MXN"},
    ...
    {{
     ...
     "TZS"},
    // CDDOOECJ6G472JDS7AOVTTNVEN47TPDOQWXSHE64TAVCZQA4EGFXOA7L
    {{
         0xc6, 0xe7, 0x10, 0x49, 0xf1, 0xb9, 0xfd, 0x24, 0x72, 0xf8, 0x1d,
         0x59, 0xcd, 0xb5, 0x23, 0x79, 0xf9, 0xbc, 0x6e, 0x85, 0xaf, 0x23,
         0x93, 0xdc, 0x98, 0x2a, 0x2c, 0xc0, 0x1c, 0x21, 0x8b, 0x77,
     },
     "LTC"},
    ...
    {{
     ...
     "yUSDC"},
    // CANBKHJ6QH45HLE5UT45HNEQTEWORC5THHXNDG26W5UJDDCM4G2INAKP
    {{
         0x1a, 0x15, 0x1d, 0x3e, 0x81, 0xf9, 0xd3, 0xac, 0x9d, 0xa4, 0xf9,
         0xd3, 0xb4, 0x90, 0x99, 0x2c, 0xe8, 0x8b, 0xb3, 0x39, 0xee, 0xd1,
         0x9b, 0x5e, 0xb7, 0x68, 0x91, 0x8c, 0x4c, 0xe1, 0xb4, 0x86,
     },
     "WXT"},
    ...
    {{
     ...
     "RIO"},
    // CDHGOVSJY546ZQ23HYWQWGICU3AYU34V5PLB67VQWYNUJIHBI7TAOHYB
    {{
         0xce, 0x67, 0x56, 0x49, 0xc7, 0x79, 0xec, 0xc3, 0x5b, 0x3e, 0x2d,
         0x0b, 0x19, 0x02, 0xa6, 0xc1, 0x8a, 0x6f, 0x95, 0xeb, 0xd6, 0x1f,
         0x7e, 0xb0, 0xb6, 0x1b, 0x44, 0xa0, 0xe1, 0x47, 0xe6, 0x07,
     },
     "SLVR"},
    ...
    {{
         0x05, 0x75, 0x46, 0xa2, 0xb7, 0xd1, 0xe1, 0x5a, 0xfe, 0x8c, 0xbc,
         0x06, 0x94, 0x6a, 0xa8, 0x9d, 0x44, 0x69, 0xe1, 0xf2, 0xe6, 0x3a,
         0x45, 0xcb, 0xda, 0x76, 0x56, 0x24, 0x51, 0xcf, 0x32, 0xb8,
     },
     "AUDD"},
    // CC546RSLM66Y34CYQDOLJ5HXOTN4C3PQ4QUH3FP3MJHOBLVUZWLE6JGG
    {{
         0xbb, 0xcf, 0x46, 0x4b, 0x67, 0xbd, 0x8d, 0xf0, 0x58, 0x80, 0xdc,
         0xb4, 0xf4, 0xf7, 0x74, 0xdb, 0xc1, 0x6d, 0xf0, 0xe4, 0x28, 0x7d,
         0x95, 0xfb, 0x62, 0x4e, 0xe0, 0xae, 0xb4, 0xcd, 0x96, 0x4f,
     },
     "CNY"},
    ...
    {{
         0x3d, 0xf2, 0x41, 0xb6, 0x33, 0xcd, 0x73, 0xd6, 0x7e, 0x27, 0x0f,
         0x0f, 0x76, 0xc4, 0xaf, 0x78, 0xa2, 0x8c, 0x3e, 0x3a, 0x46, 0x7a,
         0x89, 0x2c, 0xde, 0xea, 0xac, 0xfe, 0xea, 0x8f, 0x58, 0xdd,
     },
     "GYEN"},
    // CB3PBCKWT66NKEGKN2F7KY53I7GGRY3SXB2LKYWU6MU3ARC47GQSWWRB
    {{
         0x76, 0xf0, 0x89, 0x56, 0x9f, 0xbc, 0xd5, 0x10, 0xca, 0x6e, 0x8b,
         0xf5, 0x63, 0xbb, 0x47, 0xcc, 0x68, 0xe3, 0x72, 0xb8, 0x74, 0xb5,
         0x62, 0xd4, 0xf3, 0x29, 0xb0, 0x44, 0x5c, 0xf9, 0xa1, 0x2b,
     },
     "CLIX"},
    ...
    {{
     ...
     "BLND"},
    // CAMAJTXJDPFZL3OB72QMTAKVOXPYHAPAPD4Q5GLYW54CGDEYA4KISSQQ
    {{
         0x18, 0x04, 0xce, 0xe9, 0x1b, 0xcb, 0x95, 0xed, 0xc1, 0xfe, 0xa0,
         0xc9, 0x81, 0x55, 0x75, 0xdf, 0x83, 0x81, 0xe0, 0x78, 0xf9, 0x0e,
         0x99, 0x78, 0xb7, 0x78, 0x23, 0x0c, 0x98, 0x07, 0x14, 0x89,
     },
     "BTC"},
    ...
    {{
         0xc0, 0xd3, 0xb7, 0xce, 0xa0, 0xf2, 0xd2, 0xd8, 0x62, 0x25, 0x3d,
         0x9b, 0x09, 0x02, 0xe0, 0xde, 0x7a, 0x96, 0xef, 0xdc, 0x1e, 0x08,
         0x9c, 0x0b, 0x2b, 0x8b, 0xaf, 0x1d, 0x62, 0xe7, 0x53, 0x68,
     },
     "ZUSD"},
    ...
    {{
     ...
     "NGNC"},
    // CAZJNGLR7KI3BLUY5L46OJFHZEP6ERAF6DXNENKCUCTH4AIXTJNYXVGC
    {{
         0x32, 0x96, 0x99, 0x71, 0xfa, 0x91, 0xb0, 0xae, 0x98, 0xea, 0xf9,
         0xe7, 0x24, 0xa7, 0xc9, 0x1f, 0xe2, 0x44, 0x05, 0xf0, 0xee, 0xd2,
         0x35, 0x42, 0xa0, 0xa6, 0x7e, 0x01, 0x17, 0x9a, 0x5b, 0x8b,
     },
     "GOLD"},
    ...
    {{
     ...
     "FRED"},
    // CBAANNZVSOH6I42ZVVFTVB2JNVSHVBYUDWGGJHB4BLCXARYTNN3ODU3F
    {{
         0x40, 0x06, 0xb7, 0x35, 0x93, 0x8f, 0xe4, 0x73, 0x59, 0xad, 0x4b,
         0x3a, 0x87, 0x49, 0x6d, 0x64, 0x7a, 0x87, 0x14, 0x1d, 0x8c, 0x64,
         0x9c, 0x3c, 0x0a, 0xc5, 0x70, 0x47, 0x13, 0x6b, 0x76, 0xe1,
     },
     "KES"},
    ...
    {{
     ...
     "NGNT"},
    // CBH2J5CSQU76SGAHGLI3FUM2LMFUHGMTQH6SGYOSULNZCAMQZRIJDBDN
    {{
         0x4f, 0xa4, 0xf4, 0x52, 0x85, 0x3f, 0xe9, 0x18, 0x07, 0x32, 0xd1,
         0xb2, 0xd1, 0x9a, 0x5b, 0x0b, 0x43, 0x99, 0x93, 0x81, 0xfd, 0x23,
         0x61, 0xd2, 0xa2, 0xdb, 0x91, 0x01, 0x90, 0xcc, 0x50, 0x91,
     },
     "PALL"},
    ...
    {{
     ...
     "ARS"},
    // CCIIWFVTXWBUMZKYQIMBENXOEKSZ2JLFCZ7RNXARJCRDQYFWDWH6SSKI
    {{
         0x90, 0x8b, 0x16, 0xb3, 0xbd, 0x83, 0x46, 0x65, 0x58, 0x82, 0x18,
         0x12, 0x36, 0xee, 0x22, 0xa5, 0x9d, 0x25, 0x65, 0x16, 0x7f, 0x16,
         0xdc, 0x11, 0x48, 0xa2, 0x38, 0x60, 0xb6, 0x1d, 0x8f, 0xe9,
     },
     "PLAT"},
