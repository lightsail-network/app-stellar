...
- Delegate labels now include their parent authorization index, keeping delegated signer paths unambiguous when an operation contains multiple `Address with Delegates` entries.
